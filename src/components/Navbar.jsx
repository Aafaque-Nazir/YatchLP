        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-3 group relative z-[110]">
            <img
              src="/Logo.png"
              alt="Sea Cros Logo"
              className={`w-10 h-10 object-contain transition-all duration-500 group-hover:scale-110 ${isScrolled ? "invert brightness-0" : ""}`}
            />
        ...
        {isMobileMenuOpen && (
          <>
            ...
            >
              ...
              >
                <p className="text-sky-500 font-serif text-xl mb-2">Sea Cros</p>
