...
export default function About() {
  return (
    <section id="about" className="py-32 px-6 md:px-10 bg-navy-950 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none opacity-5 select-none pointer-events-none flex justify-center mt-10">
        <span className="text-[15vw] font-serif font-bold whitespace-nowrap text-white">VOYAGE</span>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="lg:col-span-6 relative h-[500px] md:h-[600px] w-full flex items-center justify-center">
          <motion.div
            ...
            className="absolute left-0 top-10 w-[65%] h-[75%] rounded-2xl overflow-hidden shadow-2xl border border-white/10 z-10"
          >
          ...
          <motion.div
            ...
            className="absolute right-0 bottom-0 w-[55%] h-[65%] rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-gold-500/20 z-20"
          >
        ...
        <div className="lg:col-span-6 lg:pl-10 flex flex-col justify-center">
          ...
          >
            <span className="text-gold-400 font-bold tracking-[0.2em] uppercase text-sm mb-4 block">The Philosophy</span>
            ...
            >
              ...
              <p className="text-sm tracking-[0.2em] uppercase text-white font-semibold">Redefining Luxury</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
